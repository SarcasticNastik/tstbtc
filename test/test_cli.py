...
def test_find_source_type():
    ...
    video1 = application.check_source_type(
        "https://www.youtube.com/watch?v=B0HW_sJ503Y") == "video"
    video2 = application.check_source_type(
        "https://youtu.be/B0HW_sJ503Y") == "video"
    video3 = application.check_source_type(
        "https://youtube.com/embed/B0HW_sJ503Y") == "video"
    video4 = application.check_source_type(
        "youtube.com/watch?v=B0HW_sJ503Y") == "video"
    video5 = application.check_source_type(
        "www.youtube.com/watch?v=B0HW_sJ503Y&list") == "video"
    video6 = application.check_source_type(
        "https://youtube.com/watch?v=B0HW_sJ503Y") == "video"

    playlist = application.check_source_type(
        "PLPQwGV1aLnTuN6kdNWlElfr2tzigB9Nnj") == "playlist"
    playlist1 = application.check_source_type(
        "https://www.youtube.com/playlist?list=PLPQwGV1aLnTuN6kdNWlElfr2tzigB9Nnj") == "playlist"
    playlist2 = application.check_source_type(
    ...
    playlist4 = application.check_source_type(
